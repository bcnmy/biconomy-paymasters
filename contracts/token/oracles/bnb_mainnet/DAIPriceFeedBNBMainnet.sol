...
// @note: DAI / BNB is already available here : https://bscscan.com/address/0x8EC213E7191488C7873cEC6daC8e97cdbAdb7B35#readContract
// just use appropriate method calldata when registering in oracle aggregator

contract DAIPriceFeedBNBMainnet {
    ...
    function getThePrice() public view returns (int) {
        ...
        int dai_BNB = (price2 * (10 ** 18)) / price1;
        return dai_BNB;
    }
}
