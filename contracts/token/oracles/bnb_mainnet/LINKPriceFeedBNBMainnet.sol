...
// @note: LINK / BNB is already available here : https://bscscan.com/address/0xB38722F6A608646a538E882Ee9972D15c86Fc597
// just use appropriate method when registering in oracle aggregator

contract LINKPriceFeedBNBMainnet {
    ...
    function getThePrice() public view returns (int) {
        ...
        int link_BNB = (price2 * (10 ** 18)) / price1;
        return link_BNB;
    }
}
