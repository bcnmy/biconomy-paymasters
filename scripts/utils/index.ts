...
const PRICE_FEED_DEPLOYMENT_SALTS = {
  ...
  PRICE_FEED_XAVA: "DEVX_PRICE_FEED_XAVA_V0_24072023_cGSh9uO", // 0x0000cce0a6dd4eec1137d9395d676272d5d1135e
...
export const DEV_DEPLOYMENT_SALTS = {
  ...PRICE_FEED_DEPLOYMENT_SALTS,
...
export const PROD_DEPLOYMENT_SALTS = {
  ...PRICE_FEED_DEPLOYMENT_SALTS,
...
export const paymasterStakeConfigProd: Record<number, PaymasterStakeConfig> = {
  // Testnets
  80001: {
    unstakeDelayInSec: 60 * 60 * 24, // 1 Day
    stakeInWei: parseEther("0.1"),
